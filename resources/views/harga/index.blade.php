                ...
                <table class="table table-bordered table-hover align-middle card-body">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>Rp {{ number_format($item->promo_umum ?? 0, 0, ',', '.') }}</td>  {{-- Kolom Baru --}}
                        ...
                        @empty
                            <tr>
                                <td colspan="10" class="text-center">Tidak ada data untuk kategori {{ $kategori }}.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
